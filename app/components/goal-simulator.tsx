  ...
  return (
    <section className="goalSimulator">
      ...
      {!simulator.target ? <div className="goalMissing"><strong>Objectif mensuel non renseigné</strong><p>Ajoutez l’objectif de CA du groupe dans Airtable pour activer la simulation.</p></div> : <>
        ...
        <p className="goalDirective">Cap réaliste : générer <strong>{realistic.opportunities} affaires</strong>, obtenir <strong>{realistic.appointments} rendez-vous</strong>, remettre <strong>{realistic.quotes} devis</strong> et sécuriser <strong>{realistic.wins} signatures</strong>.</p>
